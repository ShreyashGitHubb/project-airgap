...
val lightCustomColors =
  CustomColors(
    ...
    homeBottomGradient = listOf(Color(0x00F1F5F9), Color(0xFFF1F5F9)),
    agentBubbleBgColor = Color(0xFFF1F5F9), // Soft Slate/Mint
    userBubbleBgColor = Color(0xFF084B53), // Deep Teal
    linkColor = Color(0xFF084B53),
...
val darkCustomColors =
  CustomColors(
    ...
    homeBottomGradient = listOf(Color(0x001E293B), Color(0xFF0F172A)),
    agentBubbleBgColor = Color(0xFF1E293B),
    userBubbleBgColor = Color(0xFF5EEAD4),
    linkColor = Color(0xFF5EEAD4),
