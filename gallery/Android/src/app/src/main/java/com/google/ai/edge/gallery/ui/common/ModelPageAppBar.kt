...
fun ModelPageAppBar(
  ...
  CenterAlignedTopAppBar(
    title = {
      Column(
        ...
        Row(
          ...
          if (onSecurityClicked != null) {
              IconButton(onClick = onSecurityClicked, modifier = Modifier.size(20.dp)) {
                  Icon(
                      imageVector = Icons.Rounded.VerifiedUser,
                      contentDescription = "Zero-Trust Verified",
    ...
    // The back button.
    navigationIcon = {
      val enableNavigationButton = !isModelInitializing && !inProgress
      if (onMenuClicked != null) {
        IconButton(onClick = onMenuClicked, enabled = enableNavigationButton) {
          Icon(
        ...
        IconButton(onClick = onBackClicked, enabled = enableNavigationButton) {
          Icon(
